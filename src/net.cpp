...
void ThreadSocketHandler()
{
    ...
    loop
    {
        ...
        //
        BOOST_FOREACH(SOCKET hListenSocket, vhListenSocket)
        if (hListenSocket != INVALID_SOCKET && hListenSocket < 1024 && FD_ISSET(hListenSocket, &fdsetRecv))
        {
#ifdef USE_IPV6
        ...
        BOOST_FOREACH(CNode* pnode, vNodesCopy)
        {
            ...
            // Receive
            //
            if (pnode->hSocket == INVALID_SOCKET || pnode->hSocket >= 1024 )
                continue;
