...
void _fStr_allocForBuffer(fStr_t* fStr, uint8* buffer, uint32_t bufferSize, uint32_t format)
{
	fStr->str = buffer;
 ...
 */
void fStr_addHexString(fStr_t* fStr, uint8* data, uint32_t dataLength)
{
 ...
 */
sint32 fStrCmpCaseInsensitive(uint8* str1, uint8* str2, uint32_t length)
{
