...
/** set extra nonce */
void SetExtraNonce(CBlock* pblock, CBlockIndex* pindexPrev, unsigned int& nExtraNonce, bool bWithMerkle);
/** Do mining precalculation */
void FormatHashBuffers(CBlock* pblock, char* pmidstate, char* pdata, char* phash1);
/** Check mined block */
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey);
/** Check whether a block hash satisfies the proof-of-work requirement specified by nBits */
bool CheckProofOfWork(uint256 hashBlockHeader, unsigned int nBits, const CBigNum& bnPrimeChainMultiplier, unsigned int& nChainType, unsigned int& nChainLength, char **errorText);
 ...
 *               * 816115944e077fe7c803cfa57f29b36bf87c1d35: address uint16_t0
 *    - height = 203998
 *
 *
 ...
 *             * 00: special txout type pay-to-pubkey-hash
 *             * 61b01caab50f1b8e9c50a5057eb43c2d9563a4ee: address uint16_t0
 *  - vout[16]: bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4
 *              * bbd123: compact amount representation for 110397 (0.001 BTC)
 *              * 00: special txout type pay-to-pubkey-hash
 *              * 8c988f1a4a4de2161e0f50aac7f17e7f9555caa4: address uint16_t0
 *  - height = 120891
 */
class CCoins
{
 ...
 *  - uint32_t     total_transactions (4 bytes)
...
public:
    ...
    void SetBlockHeader(const CBlockHeader &header)
	{
    	...
    	this->bnPrimeChainMultiplier = header.bnPrimeChainMultiplier;
	}
    ...
    void print() const
    {
    	fprintf(stderr, "CBlock(hash=%s, hashBlockHeader=%s, ver=%d, hashPrevBlock=%s, hashMerkleRoot=%s, nTime=%u, nBits=%08x, nNonce=%u, vtx=%"PRIszu")\n",
            GetHash().ToString().c_str(),
        ...
        for (unsigned int i = 0; i < vMerkleTree.size(); i++)
        	fprintf(stderr,"%s ", vMerkleTree[i].ToString().c_str());
        fprintf(stderr, "\n");
    }
